...
* **Threshold Dependency:** The filtering of the ERA5 dataset relied heavily on a strict statistical threshold (-2,+2 standard deviations). While this effectively isolated extreme climate episodes, it significantly reduced the effective sample size (about 250 - 300 days) and ignored softer, cumulative climate trends.
